      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex-1 max-w-2xl hidden md:flex relative">
            ...
            />
            <button className="absolute right-1 top-1 p-1.5 bg-blue-900 text-white rounded hover:bg-blue-800">
              <FaSearch />
            </button>
          </div>
          ...
          <div className="flex items-center gap-4 text-blue-900 font-bold text-sm">
            <Link href="#" className="flex items-center gap-1 hover:text-white transition hidden sm:flex">
        ...
        <div className="mt-3 md:hidden relative">
          <input type="text" placeholder="Tìm kiếm trên Ngư Dân Số..." className="w-full pl-4 pr-10 py-2 rounded text-sm outline-none"/>
